  ...
  return `
    <section class="bg-gray-800 md:border md:border-gray-700 md:rounded-xl p-0 md:p-6">
      <div id="playerContainer" class="relative">
        <div id="placeholder" class="aspect-video bg-gray-700 md:rounded-lg flex items-center justify-center">
        ...
        <video id="videoPlayer" class="w-full aspect-video md:rounded-lg hidden" controls autoplay playsinline preload="none"></video>

        <div id="streamLoading" class="absolute inset-0 bg-gray-900/75 md:rounded-lg flex items-center justify-center hidden">
        ...
        <div id="streamError" class="absolute inset-0 bg-gray-900/90 md:rounded-lg flex items-center justify-center hidden">
